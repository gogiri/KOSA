...
public class ClubServiceImpl implements ClubService {
  ...
  static final String CLUBFILEPATH =
      "C:/Users/KOSA/Desktop/project5/KOSA/src/main/java/com/msa2024/club/club.json";
  ...
  public void printClub() {
    ...
    try {
      ...
      List<Club> clubs =
          objectMapper.readValue(new File(CLUBFILEPATH), new TypeReference<List<Club>>() {});
  ...
  public void deleteClub() {
    Scanner scdc = new Scanner(System.in);
    ObjectMapper objectMapper = new ObjectMapper();

    System.out.println("삭제할 소모임 번호를 입력하세요: ");
    int clubNumberToDelete = scdc.nextInt();
